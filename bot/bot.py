...
class WaterBillBot:
    ...
    def _setup_scheduled_jobs(self):
        ...
        # Monthly scrape on the 1st at 6 AM
        self.scheduler.add_job(
            self.scheduled_scrape,
            CronTrigger(day=1, hour=6, minute=0),
            id="monthly_scrape",
            name="Monthly bill scrape"
        )
                ...
                for city, city_properties in properties_by_city.items():
                    ...
                    for prop in city_properties:
                        try:
                            ...
                            # Try HTTP first (no browser, bypasses reCAPTCHA)
                            ...
                            if not bill_data:
                                ...
                                logger.info(f"HTTP search failed for {prop.address}, trying address: {street_address}")
